...
{	
	...
	GPIO_Init(BH1750_SCL_Prot,&GPIO_InitStructure);
	
	//PG15-ADDR
	GPIO_InitStructure.GPIO_Pin = BH1750_ADDR_Pin;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;
	GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;
	GPIO_Init(BH1750_ADDR_Prot,&GPIO_InitStructure);	
}
...
void SDA_OUT()
{
	...
	GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;
	GPIO_Init(BH1750_SDA_Prot,&GPIO_InitStructure);
