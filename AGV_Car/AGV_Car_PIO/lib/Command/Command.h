...
public:
	...
	uint8_t HW_Dimming1[4] = { 0x00,0xff,0x0c,0xF3};						/*光源档位 加1 命令					不修改*/		
	uint8_t HW_Dimming2[4] = { 0x00,0xff,0x18,0xE7};						/*光源档位 加2 命令					不修改*/
	uint8_t HW_Dimming3[4] = { 0x00,0xff,0x5e,0xA1};						/*光源档位 加3 命令					不修改*/
